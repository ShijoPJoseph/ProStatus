...
app.post ('/Question', function (req, resp) {
	...
	var inpMessage = req.body.depQuestion;
	inpMessage = inpMessage.replace(':)', '&#128578;');
	inpMessage = inpMessage.replace(':-)', '&#128578;');
	...
	{    var substring = "?";
		...
		{
	strTowrite = '<p class="qa"> \n' + '<div class="q"><span><b>' + actUser +'</b> : </span>' + inpMessage + ' ?</div><div class="a"><span><i>INTC Team</i> : </span> Thanks for your question. We would soon come back</div></p>'
		}
		else
		{
				strTowrite = '<p class="qa"> \n' + '<div class="q"><span><b>' + actUser +'</b> : </span>' + inpMessage + '</div><div class="a"><span><i>INTC Team</i> : </span> Thanks for your question. We would soon come back</div></p>'
	...
	{
	strTowrite = '<p class="qa"> \n' + '<div class="q"><span><b>' + actUser +'</b> : </span>' + inpMessage + ' </div><div class="a"><span><i>INTC Team</i> : </span> Thanks for your comment</div></p>'
	}
	
	if ( req.body.cmtType == 'sugession')
	{
	strTowrite = '<p class="qa"> \n' + '<div class="q"><span><b>' + actUser +'</b> : </span>' + inpMessage + ' </div><div class="a"><span><i>INTC Team</i> : </span> Thanks for your Sugession. We value them</div></p>'
	}
